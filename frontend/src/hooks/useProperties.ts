...
export const MOCK_PUBLIC_PROPERTIES: Property[] = [
  {
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=900&h=600&fit=crop&q=80', isPrimary: true, caption: 'Front exterior' },
      { url: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=900&h=600&fit=crop&q=80', isPrimary: false, caption: 'Kitchen' },
      { url: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=900&h=600&fit=crop&q=80', isPrimary: false, caption: 'Living room' },
      { url: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop&q=80', isPrimary: false, caption: 'Master bedroom' },
    ],
  ...
  },
  {
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=900&h=600&fit=crop&q=80', isPrimary: true, caption: 'Living area' },
      { url: 'https://images.unsplash.com/photo-1484154218962-a197022b5858?w=900&h=600&fit=crop&q=80', isPrimary: false, caption: 'Kitchen' },
      { url: 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=900&h=600&fit=crop&q=80', isPrimary: false, caption: 'Bedroom' },
      { url: 'https://images.unsplash.com/photo-1564078516393-cf04bd966897?w=900&h=600&fit=crop&q=80', isPrimary: false, caption: 'Bathroom' },
    ],
  ...
  },
  {
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=900&h=600&fit=crop&q=80', isPrimary: true, caption: 'Kitchen' },
      { url: 'https://images.unsplash.com/photo-1598928506311-c55ded91a20c?w=900&h=600&fit=crop&q=80', isPrimary: false, caption: 'Exterior' },
      { url: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=900&h=600&fit=crop&q=80', isPrimary: false, caption: 'Living room' },
      { url: 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=900&h=600&fit=crop&q=80', isPrimary: false, caption: 'Bedroom' },
    ],
    agent: { _id: 'a1', firstName: 'Sarah', lastName: 'Mitchell', email: 'sarah@nuvistarealty.ca', phone: '519-438-5478' },
    views: 312,
    favorites: 24,
  ...
  },
  {
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop&q=80', isPrimary: true, caption: 'Front exterior' },
      { url: 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=900&h=600&fit=crop&q=80', isPrimary: false, caption: 'Pool area' },
      { url: 'https://images.unsplash.com/photo-1616594039964-ae9021a400a0?w=900&h=600&fit=crop&q=80', isPrimary: false, caption: 'Kitchen' },
      { url: 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=900&h=600&fit=crop&q=80', isPrimary: false, caption: 'Primary suite' },
    ],
  ...
  },
  {
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=900&h=600&fit=crop&q=80', isPrimary: true, caption: 'Living area' },
      { url: 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=900&h=600&fit=crop&q=80', isPrimary: false, caption: 'Bedroom' },
      { url: 'https://images.unsplash.com/photo-1484154218962-a197022b5858?w=900&h=600&fit=crop&q=80', isPrimary: false, caption: 'Kitchen' },
      { url: 'https://images.unsplash.com/photo-1564078516393-cf04bd966897?w=900&h=600&fit=crop&q=80', isPrimary: false, caption: 'Bathroom' },
    ],
  ...
  },
  {
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=900&h=600&fit=crop&q=80', isPrimary: true, caption: 'Front exterior' },
      { url: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=900&h=600&fit=crop&q=80', isPrimary: false, caption: 'Kitchen' },
      { url: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=900&h=600&fit=crop&q=80', isPrimary: false, caption: 'Living room' },
      { url: 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=900&h=600&fit=crop&q=80', isPrimary: false, caption: 'Master bedroom' },
    ],
    agent: { _id: 'a3', firstName: 'Priya', lastName: 'Nair', email: 'priya@nuvistarealty.ca', phone: '519-438-5480' },
    views: 147,
    favorites: 9,
  ...
  },
  {
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1598928506311-c55ded91a20c?w=900&h=600&fit=crop&q=80', isPrimary: true, caption: 'Front exterior' },
      { url: 'https://images.unsplash.com/photo-1616594039964-ae9021a400a0?w=900&h=600&fit=crop&q=80', isPrimary: false, caption: 'Kitchen' },
      { url: 'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=900&h=600&fit=crop&q=80', isPrimary: false, caption: 'Backyard' },
      { url: 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=900&h=600&fit=crop&q=80', isPrimary: false, caption: 'Primary suite' },
    ],
    agent: { _id: 'a1', firstName: 'Sarah', lastName: 'Mitchell', email: 'sarah@nuvistarealty.ca', phone: '519-438-5478' },
    views: 0,
  ...
  },
  {
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1568605114967-8130f3a36994?w=900&h=600&fit=crop&q=80', isPrimary: true, caption: 'Front exterior' },
      { url: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=900&h=600&fit=crop&q=80', isPrimary: false, caption: 'Kitchen' },
      { url: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=900&h=600&fit=crop&q=80', isPrimary: false, caption: 'Living room' },
      { url: 'https://images.unsplash.com/photo-1564078516393-cf04bd966897?w=900&h=600&fit=crop&q=80', isPrimary: false, caption: 'Bathroom' },
    ],
